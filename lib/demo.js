...
module.exports = () => {
  ...
  let clear = () => {
    ...
    status = 'PASSING'
    // Send passing alarm
    stoplight.green.next({event: 'ENABLE', delay: 0})
    stoplight.green.next({event: 'DISABLE', delay: 3000})
  ...
  let build = () => {
    ...
    // Send BILD to display

    // Send busy alarm
    stoplight.yellow.next({event: 'ENABLE', delay: 0})
    stoplight.yellow.next({event: 'DISABLE', delay: 3000})
