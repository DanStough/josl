...
let startSequence = [
  ...
  {delay: 1000, source: 'GREEN', type: 'DISABLE'},
  {delay: 1000, source: 'YELLOW', type: 'ENABLE'},

  {delay: 1000, source: 'YELLOW', type: 'DISABLE'},
  {delay: 1000, source: 'RED', type: 'ENABLE'},

  {delay: 1000, source: 'YELLOW', type: 'ENABLE'},
  {delay: 1000, source: 'GREEN', type: 'ENABLE'},
  {delay: 1000, source: 'ALARM', type: 'ENABLE'},

  {delay: 3000, source: 'ALARM', type: 'DISABLE'},
  {delay: 3000, source: 'GREEN', type: 'DISABLE'},
  {delay: 3000, source: 'YELLOW', type: 'DISABLE'},
  {delay: 3000, source: 'RED', type: 'DISABLE'}
]
    ...
    this.indicatorSub = this.eventSubject
      ...
      .subscribe((event) => {
        if (event.source in indicatorHandler) {
          indicatorHandler[event.source](event)
        } else {
