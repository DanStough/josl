...
module.exports = class Indicator {
  constructor (name, pinId) {
    ...
    let rxHandler = {
      TOGGLE: (e) => { this.toggleEnable(e) },
      ENABLE: (e) => { this.enable(e) },
      DISABLE: (e) => { this.disable(e) },
      TOGGLE_FLASH: (e) => { this.toggleFlash(e) },
      FLASH: (e) => { this.flash(e) },
      STEADY: (e) => { this.steady(e) }
    }

    this.subject = new rx.Subject()

    this.subscription = this.subject.concatMap(event => {
